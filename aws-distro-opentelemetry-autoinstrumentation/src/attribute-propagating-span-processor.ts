...
export class AttributePropagatingSpanProcessor implements SpanProcessor {
  ...
  public static create(propagationDataExtractor: (span: ReadableSpan) => string, propagationDataKey: string, attributesKeysToPropagate: string[]): AttributePropagatingSpanProcessor {
    return new AttributePropagatingSpanProcessor(propagationDataExtractor, propagationDataKey, attributesKeysToPropagate);
  }

  private constructor(propagationDataExtractor: (span: ReadableSpan) => string, propagationDataKey: string, attributesKeysToPropagate: string[]) {
