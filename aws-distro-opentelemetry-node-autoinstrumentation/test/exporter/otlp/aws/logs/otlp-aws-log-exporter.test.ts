...
import { LARGE_LOG_HEADER, OTLPAwsLogExporter } from '../../../../../src/exporter/otlp/aws/logs/otlp-aws-log-exporter';
    ...
    exporter
      ...
      .then(() => {
        scope.on('request', (req, interceptor, body) => {
          ...
          expect(headers).not.toHaveProperty(LARGE_LOG_HEADER);
    ...
    exporter
      ...
      .then(() => {
        scope.on('request', (req, interceptor, body) => {
          ...
          expect(headers).toHaveProperty(X_AMZ_SECURITY_TOKEN_HEADER.toLowerCase());
          expect(headers).toHaveProperty(X_AMZ_DATE_HEADER.toLowerCase());
          expect(headers).toHaveProperty(LARGE_LOG_HEADER);
