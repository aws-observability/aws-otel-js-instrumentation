...
describe('SFN', () => {
  ...
  describe('DescribeStateMachine', () => {
    it('span has stateMachineArn in its attributes', async () => {
      const stateMachineArn: string = "arn:aws:states:us-east-1:007003123456789012:activity:testActivity";
      ...
      expect(stateMachineAttributeSpan.attributes[AWS_ATTRIBUTE_KEYS.AWS_STEPFUNCTIONS_STATEMACHINE_ARN]).toBe(stateMachineArn);
